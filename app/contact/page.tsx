            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6">
                {contactMethods.map((method, idx) => (
                  ...
                  >
                    <Card className="p-8 h-full hover:shadow-2xl transition-all duration-300 border-2 hover:border-purple-200 group cursor-pointer">
        ...
        <section className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-gray-50">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              {/* Form */}
              <AnimatedSection>
                <Card className="p-8 sm:p-12 border-2 shadow-xl">
                  <h2 className="text-4xl font-bold mb-3 text-gray-900">Send us a message</h2>
                  ...
                  {isSubmitted ? (
                    ...
                    >
                      ...
                      <p className="text-gray-600 text-center">Thank you for reaching out. We&apos;ll be in touch soon.</p>
                    </motion.div>
                  ) : (
              ...
              <div className="space-y-8">
                <AnimatedSection>
                  <Card className="p-8 border-2 bg-gradient-to-br from-purple-50 to-pink-50">
                    <Rocket className="w-12 h-12 text-purple-600 mb-4" />
                    <h3 className="text-2xl font-bold mb-3 text-gray-900">Ready to Start?</h3>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="w-5 h-5 text-purple-600 flex-shrink-0 mt-1" />
                        <span className="text-gray-700">Custom solution proposals</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <CheckCircle2 className="w-5 h-5 text-purple-600 flex-shrink-0 mt-1" />
                ...
                <AnimatedSection>
                  <Card className="p-8 border-2">
                    ...
                    <p className="text-gray-600 mb-6">Stay updated with our latest products and innovations.</p>
                    <div className="flex gap-3">
                      {socialLinks.map((social, idx) => (
                        <a
                          key={idx}
                          href={social.link}
                          className={`w-12 h-12 rounded-xl bg-gray-100 hover:text-white ${social.color} flex items-center justify-center transition-all duration-300`}
                        >
